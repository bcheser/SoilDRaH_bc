...
Kathleen J Duguay, John N Klironomos,
...
2000,
Pages 157-164,
https://doi.org/10.1016/S0929-1393(00)00049-4.



@Duguay2000 aims to compare the effects of UV-B radiation on litter decomposition, both directly and indirectly and competition between saprobic fungi.
The study contains two main experiments; the first tested the impact of the UV-B on both the litter during growth (indirect effect) and during decomposition (direct effect), and the second experiment measured the difference in decomposition rates between pigmented and hyaline fungi.
